...
async function getAPI() {
    ...
    function mostrarCarrito(carritodecompras) {
        compra = "";
        let totalPorProducto = carritodecompras.cantidad * carritodecompras.precio;
        console.log(carritodecompras);
        compra +=
            `<tr>
                        <td>${carritodecompras.nombre}</td>
                        <td>${carritodecompras.cantidad}</td>
                        <td>${carritodecompras.precio}</td>
                        <td>${totalPorProducto}</td>
                        <td>
                            <button class="btn btn-danger eliminar" onclick="eliminar(${carritodecompras._id})">Eliminar
