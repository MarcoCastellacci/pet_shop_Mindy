...
// let arrayLocalStorageFarmacia = JSON.parse(localStorage.getItem('farmacia'));
// let arrayLocalStorageJuguete = JSON.parse(localStorage.getItem('juguete'));


// carrito = [...carrito, arrayLocalStorageFarmacia, arrayLocalStorageJuguete]

// console.log(carrito);

// console.log(arrayLocalStorageFarmacia);
// console.log(arrayLocalStorageJuguete);
